...
import bassNotes from "../Piano/bassNotes";
  ...
  return (
    <div className="piano-controller-container">
      ...
      <div className="clef-container">
        <button
          className={`clef-btn treble-clef ${
            isTrebleClef && "active-clef-btn"
          }`}
          onClick={() => handleClef(trebleNotes, true)}
        >
          <svg
            fill="#000000"
            version="1.1"
        ...
        <button
          className={`clef-btn bass-clef ${!isTrebleClef && "active-clef-btn"}`}
          onClick={() => handleClef(bassNotes, false)}
        >
